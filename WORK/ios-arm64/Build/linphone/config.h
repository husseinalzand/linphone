...
#define LINPHONE_MINOR_VERSION 8
#define LINPHONE_MICRO_VERSION 5
#define LINPHONE_VERSION "3.8.5"
#define LIBLINPHONE_VERSION "3.8.5"

#define LINPHONE_ALL_LANGS "ar cs de es fr he hu it ja lt nb_NO nl pl pt_BR ru sr sv tr zh_CN zh_TW"
