...
set(OSX_FLAGS "")
if(NOT "arm64" STREQUAL "")
	set(OSX_FLAGS "${OSX_FLAGS} -arch arm64")
endif()
...
if("Clang" STREQUAL "GNU")
	string(REGEX REPLACE "gcc$" "as" AS_COMPILER "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-clang")
	set(AUTOTOOLS_AS_COMPILER ${AS_COMPILER} CACHE PATH "Initial cache" FORCE)
endif()
set(AUTOTOOLS_C_COMPILER "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-clang ${OSX_FLAGS}" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_CXX_COMPILER "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-clang++ ${OSX_FLAGS}" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_OBJC_COMPILER "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-clang ${OSX_FLAGS}" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_LINKER "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-ld" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_AR "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-ar" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_RANLIB "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-ranlib" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_STRIP "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-strip" CACHE PATH "Initial cache" FORCE)
set(AUTOTOOLS_NM "/Users/husseinalzandvirtual/linphone-iphone/WORK/ios-arm64/cmake/Autotools/arm64-apple-darwin-nm" CACHE PATH "Initial cache" FORCE)
