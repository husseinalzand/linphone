...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIImageView *cellBackView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 240, 192)];
    cellBackView.backgroundColor=[UIColor clearColor];
    
    
    cellBackView.image = [UIImage imageNamed:@"v.png"];
    cellBackView.alpha=0.5;
    
    
    tableView.backgroundView = cellBackView;
...
- (void)emailAttachments:(NSArray *)attachments {/* hussein////////////////////////
	NSString *error = nil;
