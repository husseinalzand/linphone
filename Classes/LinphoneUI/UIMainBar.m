...
- (void)viewDidLoad {
...

	{
		...
		//[historyButton setBackgroundImage:[UIImage imageNamed:@"history_selected.png"]forState:(UIControlStateHighlighted | UIControlStateSelected)];
...

	{
		...
		// Set selected+over background: IB lack !
		//[contactsButton setBackgroundImage:[UIImage imageNamed:@"contacts_selected.png"] forState:(UIControlStateHighlighted | UIControlStateSelected)];
	...
	}
	{
		...
		// Set selected+over background: IB lack !
		//[dialerButton setBackgroundImage:[UIImage imageNamed:@"dialer_selected.png"]forState:(UIControlStateHighlighted | UIControlStateSelected)];
	...
	}
	{
		...
		// Set selected+over background: IB lack !
		//[settingsButton setBackgroundImage:[UIImage imageNamed:@"settings_selected.png"]forState:(UIControlStateHighlighted | UIControlStateSelected)];
...

	{
		...
		// Set selected+over background: IB lack !
		//[chatButton setBackgroundImage:[UIImage imageNamed:@"chat_selected.png"]forState:(UIControlStateHighlighted | UIControlStateSelected)];
